...
export default function Promotes() {
  return (
    <div
      className="bg-black text-white relative pt-10 md:pt-50"
      style={{
        backgroundImage:
          "url(https://images.unsplash.com/photo-1706164971302-e30c0640cc3b?q=80&w=2532&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)",
      ...
      <div className="section relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 items-end">
          <div className="cta md:col-span-2">
            ...
            <p className="py-4 text-white text-1xl">
